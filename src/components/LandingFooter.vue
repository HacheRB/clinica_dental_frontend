<template>
  <v-footer color="teal lighten-2 text-left white--text" padless absolute>
    <v-container fluid>
      ...
      <v-row class="d-flex flex-col pt-5">
        <!-- Ubicacion -->
        <v-col
          class="d-none d-sm-flex flex-col justify-center"
          cols="12"
          sm="4"
          md="4"
        >
          <v-card flat tile class="teal lighten-2 white--text text-center">
            <p
              cols="12"
        ...
        <!-- Ubicacion  Movil-->
        <v-col
          class="d-flex d-sm-none flex-col justify-center"
          cols="12"
          sm="4"
          md="4"
        >
        ...
        <!-- Horario -->
        <v-col
          class="d-flex d-sm-flex flex-col justify-center"
          cols="12"
          sm="4"
          md="4"
        >
      ...
      <v-row>
        <v-col class="py-4 text-center white--text" cols="12">
          {{ new Date().getFullYear() }} — <strong>Clinica Marrero</strong>
        </v-col>
      </v-row>
    </v-container>
  </v-footer>
